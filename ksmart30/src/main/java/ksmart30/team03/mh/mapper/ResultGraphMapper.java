...
public interface ResultGraphMapper {
	...
	List<ResultList> getResultGraph(Map<String, Object> map);
	//5.2.1 M/H 실적 그래프 뿌려주기
	List<ResultList> getResultGraph2(Map<String, Object> map);
	
	//5.2.1 M/H 단계별 인건비 누계(계획) 그래프 뿌려주기
	List<ResultCost> getResultGraphPlanNugae(Map<String, Object> map); 
	//5.2.1 M/H 단계별 인건비 누계(실적) 그래프 뿌려주기
	List<ResultCost> getResultGraphResultNugae(Map<String, Object> map);
